        ...
        <div class="max-w-4xl mx-auto px-8 md:px-12">
            ...
            <div class="flex flex-wrap items-center gap-3 mb-6">
                ...
                <span class="flex items-center text-sm text-gray-400">
                    ...
                    {{ number_format($program->view_count) }}
                </span>
            </div>
            ...
            <div class="grid grid-cols-2 gap-8">
                <div>
                    @if ($previousMaterial && $previousMaterial->slug)
                        <a href="{{ route('program.show', ['locale' => app()->getLocale(), 'slug' => $previousMaterial->slug]) }}"
                ...
                <div class="text-right">
                    @if ($nextMaterial && $nextMaterial->slug)
                        <a href="{{ route('program.show', ['locale' => app()->getLocale(), 'slug' => $nextMaterial->slug]) }}"
